...
// import { createPost, deletePost, fetchPosts } from "../src/redux/postsSlice";
...
//       dispatch(fetchPosts());
//     }
//   }, [dispatch, status]); // Only fetch if status is "idle"
...
//             <p className="text-gray-600">{post.body.substring(0, 100)}...</p>
//             <div className="mb-4 flex justify-between">
//               <Link to={`/post/${post.id}`} className="text-blue-500 mt-2">
//                 Read More
//               </Link>
//               <button
